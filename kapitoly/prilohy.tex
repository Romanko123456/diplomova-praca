...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.95\textwidth, height=0.9\textheight, keepaspectratio]{obrazky/page_63_scan.png}
    \caption*{Sken schválenej žiadosti (strana 63)}
\end{figure}
\clearpage
...
\noindent Vek: \dots\dots\dots\dots\dots\dots rokov \\
\noindent Výška : \dots\dots\dots\dots\dots\dots cm \\
\noindent Hmotnosť : \dots\dots\dots\dots\dots\dots kg
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.95\textwidth, height=0.9\textheight, keepaspectratio]{obrazky/page_71_scan.png}
    \caption*{Sken prílohy (strana 71)}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.95\textwidth, height=0.9\textheight, keepaspectratio]{obrazky/page_72_scan.png}
    \caption*{Sken prílohy (strana 72)}
\end{figure}
